...
<?php
	session_start();
	echo '<p class="info-small">Dodaj novost</p><br>';
	...
	echo 	'<textarea id="detaljno" name="detaljno" class="contact-textarea" rows="10" cols="10"></textarea>';
    echo    '<div id="detaljnoErrorProvider">
			...
			<button id="registruj" class="register-button" name="registruj" onclick="createNews()" type="button">Dodaj novost</button>
	     </form>';
?>